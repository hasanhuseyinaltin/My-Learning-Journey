...
class HouseCat extends Cat {
    constructor(HouseCatSound = "meow",sound, canJumpHigh, canClimpTrees, color, energy) {
        super(sound,canClimpTrees, canJumpHigh, color, energy);
...
class Tiger extends Cat {
    constructor(tigerSound ="Roar!" ,sound, canClimpTrees, canJumpHigh, color, energy) {
        super(sound, canClimpTrees, canJumpHigh, color, energy);
...
class Parrot extends Bird {
    constructor(canTalk = false, canFly, sound, color, energy) {
        super(canFly, sound, color, energy);
